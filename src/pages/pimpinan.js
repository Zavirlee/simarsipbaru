      ...
      <div id="dashboard">
        <div className="row d-flex justify-content-center align-items-center mt-3">
          <div className="col-12 col-md-8 d-flex justify-content-center align-items-center flex-column">
            <img src={Icon} alt="icon" className="p-2 w-25" />
          </div>
        </div>
        ...
        <div className="row d-flex justify-content-center align-items-center mt-3">
          ...
          >
            <div className="card-body row d-flex justify-content-center align-items-center text-center" role="button">
              <div className="col-md-3 col-3" >
                <CgFileDocument className="fs-1" />{" "}
                {/* Adjust the fs-4 class to set the desired size */}
              </div>
              <div className="col-md-9 col-9 justify-content-center align-items-center ">
